...
Provides @json_tool and @handle_repo_errors decorators for consistent
...
def json_tool(
    ...
    wrapper._is_json_tool = True  # type: ignore[attr-defined]  # Marker for handle_repo_errors detection
    return wrapper
